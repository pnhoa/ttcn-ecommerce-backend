...
public class ProductAPI {
    ...
    public ResponseEntity<MessageResponse> createProduct(@Valid @RequestBody ProductDTO theProductDto,
        ...
        if (theBindingResult.hasErrors()) {
            return new ResponseEntity<MessageResponse>(new MessageResponse("Invalid value for create product",
    ...
    public ResponseEntity<MessageResponse> updateProduct(@PathVariable("id") Long theId,
        ...
        if (bindingResult.hasErrors()) {
            return new ResponseEntity<MessageResponse>(new MessageResponse("Invalid value for update product",
                    HttpStatus.BAD_REQUEST, LocalDateTime.now()), HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> deleteProduct(@PathVariable("id") Long theId) {
        ...
        return new ResponseEntity<>(new MessageResponse("Delete successfully!", HttpStatus.OK, LocalDateTime.now()),
                HttpStatus.OK);
    }
